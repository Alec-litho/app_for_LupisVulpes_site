...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="http://localhost/app_for_lupisvulpes_site/root/resources/css/imageAnimation.css">
                ...
                <div class="col-6 ">
                    <form action="{{route('art.store')}}" method="post" enctype="multipart/form-data" class="form">
                      ...
                      <h5 for="formFile">{{__('Load Art')}}</h5> 
                        ...
                        <div class="form-group d-none justify-content-center align-content-center gap-2 mt-2 fileResult">
                        ...
                        <div class="form-group">
                          ...
                          @error('characters')
                          <p class="text-danger">{{$message}} {{session("characters")}}</p>
                          @enderror
                        </div>
    ...
    <script type="module" src="http://localhost/app_for_lupisvulpes_site/root/resources/js/loadImg.js"></script>
    <script type="module" src="http://localhost/app_for_lupisvulpes_site/root/resources/js/identifyBaseColor.js"></script>
    <script type="module" src="http://localhost/app_for_lupisvulpes_site/root/resources/js/setColors.js"></script>
</html>